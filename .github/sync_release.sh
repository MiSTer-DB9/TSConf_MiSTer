...
UPSTREAM_REPO="https://github.com/MiSTer-devel/TSConf_MiSTer.git"
CORE_NAME=(TSConf)
...
UPSTREAM_CORE_NAME=(TSConf)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(TSConf.qpf)
COMPILATION_OUTPUT=(output_files/TSConf.rbf)
